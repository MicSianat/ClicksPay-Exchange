      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <h3 className="text-4xl font-bold text-secondary">Tailored Financial Services</h3>
            <p className="text-slate-600">Secure, fast, and reliable solutions for your everyday financial needs.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="h-full border-none shadow-lg hover:shadow-xl transition-shadow rounded-3xl overflow-hidden bg-white">
                <CardContent className="p-8 space-y-6">
                  <div className="h-16 w-16 bg-primary/10 rounded-2xl flex items-center justify-center">
                    <Bitcoin className="h-8 w-8 text-primary" />
                  </div>
                  <div className="space-y-2">
                    <h4 className="text-2xl font-bold text-secondary">Crypto Exchange</h4>
            ...
            >
              <Card className="h-full border-none shadow-lg hover:shadow-xl transition-shadow rounded-3xl overflow-hidden bg-white">
                <CardContent className="p-8 space-y-6">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-2xl font-bold text-secondary">Payment Agency</h4>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center space-y-4 p-6">
              ...
              <h4 className="text-xl font-bold text-secondary">Secure Transactions</h4>
              <p className="text-slate-500">Bank-grade encryption for all your digital assets and payments.</p>
            </div>
            <div className="flex flex-col items-center text-center space-y-4 p-6">
              <Zap className="h-12 w-12 text-primary" />
              <h4 className="text-xl font-bold text-secondary">Fast Processing</h4>
              <p className="text-slate-500">Quick settlements and immediate confirmations on all orders.</p>
            </div>
            <div className="flex flex-col items-center text-center space-y-4 p-6">
              <Wallet className="h-12 w-12 text-primary" />
              <h4 className="text-xl font-bold text-secondary">Reliable Service</h4>
              <p className="text-slate-500">A trusted name in payment agency and crypto exchange services.</p>
            </div>
          </div>
        </div>
      </section>
